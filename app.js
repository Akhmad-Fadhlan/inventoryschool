...
function setupEventListeners() {
  ...
  document.getElementById('btn-new-borrowing').addEventListener('click', () => {
...
function bootstrapModalsDropdowns() {
  ...
  // Handle room changes dynamically based on selected branch
  ...
  // Populate dynamic select list for assets when modal opens
  ...
  document.getElementById('btn-new-maintenance').addEventListener('click', async () => {
    ...
    renderAssetsDropdown(select, { condition: 'DAMAGED' }); // Allow repairing damaged assets
  });
